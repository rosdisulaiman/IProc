...
namespace IProc.Web
{
    ...
    public class AquariumExtenderBase : ExtenderControl
    {
        ...
        protected override System.Collections.Generic.IEnumerable<ScriptReference> GetScriptReferences()
        {
            ...
            var isMobile = ApplicationServices.IsTouchClient;
            ...
            if (ci.Name != "en-US")
                scripts.Add(new ScriptReference(string.Format("IProc.js.sys.culture.{0}.js", ci.Name), assemblyFullName));
            if (EnableMinifiedScript)
            {
                if (isMobile)
                {
                    scripts.Add(new ScriptReference(("IProc.js.sys.jquery-2.2.4" + fileType), assemblyFullName));
                    if (uiFramework && ((!EnableCombinedScript || (HttpContext.Current.Request.Params["_cf"] == "bootstrap")) && Convert.ToBoolean(ApplicationServicesBase.Settings("server.bootstrap.js"))))
                        scripts.Add(new ScriptReference("IProc.js.sys.bootstrap.min.js", assemblyFullName));
                    if (uiFramework)
                        scripts.Add(new ScriptReference(("IProc.js.daf.touch-core" + fileType), assemblyFullName));
                }
                else
                    scripts.Add(new ScriptReference("IProc.js.sys._System.js", assemblyFullName));
                scripts.Add(new ScriptReference("IProc.js.sys.MicrosoftAjax.min.js", assemblyFullName));
                if (!isMobile)
                {
                    scripts.Add(new ScriptReference("IProc.js.sys.AjaxControlToolkit.min.js", assemblyFullName));
                    scripts.Add(new ScriptReference("IProc.js.sys.MicrosoftAjaxWebForms.min.js", assemblyFullName));
                }
                scripts.Add(new ScriptReference(CultureManager.ResolveEmbeddedResourceName(("IProc.js.daf.daf-resources" + fileType)), assemblyFullName));
                if (!isMobile)
                    scripts.Add(new ScriptReference(("IProc.js.daf.daf-menu" + fileType), assemblyFullName));
                scripts.Add(new ScriptReference(("IProc.js.daf.daf" + fileType), assemblyFullName));
                scripts.Add(new ScriptReference(("IProc.js.daf.daf-odp" + fileType), assemblyFullName));
                scripts.Add(new ScriptReference(("IProc.js.daf.daf-ifttt" + fileType), assemblyFullName));
                if (!isMobile)
                    scripts.Add(new ScriptReference(("IProc.js.daf.classic" + fileType), assemblyFullName));
                if (!isMobile)
                {
                    if (new ControllerUtilities().SupportsScrollingInDataSheet)
                        scripts.Add(new ScriptReference(("IProc.js.daf.daf-extensions" + fileType), assemblyFullName));
                }
                if (EnableCombinedScript || !uiFramework)
                    scripts.Add(new ScriptReference(("IProc.js.daf.daf-membership" + fileType), assemblyFullName));
                ConfigureScripts(scripts);
                if (isMobile)
                {
                    if (uiFramework)
                    {
                        scripts.Add(new ScriptReference(("IProc.js.daf.touch" + fileType), assemblyFullName));
                        scripts.Add(new ScriptReference(("IProc.js.daf.input-blob" + fileType), assemblyFullName));
                        scripts.Add(new ScriptReference(("IProc.js.daf.touch-edit" + fileType), assemblyFullName));
                        scripts.Add(new ScriptReference(("IProc.js.daf.touch-charts" + fileType), assemblyFullName));
                    }
                    scripts.Add(new ScriptReference(("IProc.js.sys.unicode" + fileType), assemblyFullName));
                }
            }
            else
            {
        ...
        protected virtual void ConfigureScripts(List<ScriptReference> scripts)
        {
            if (RequiresMembershipScripts && !EnableCombinedScript)
            {
                if (EnableMinifiedScript)
                {
                    scripts.Add(new ScriptReference(CultureManager.ResolveEmbeddedResourceName("IProc.js.daf.daf-resources.min.js"), GetType().Assembly.FullName));
                    scripts.Add(new ScriptReference("IProc.js.daf.daf-membership.min.js", GetType().Assembly.FullName));
                }
                else
                {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            {
                ID = "IProcTheme",
                Href = Page.ClientScript.GetWebResourceUrl(typeof(AquariumExtenderBase), "IProc.Theme.Aquarium.css")
            };
